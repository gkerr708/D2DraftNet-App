...
"""
This is coppied from the main directory. Yes I know, this is dumb. 
It should be imported, but I can't use that imported file because
this is being hosted on a server. In future versions, the main
project should be uploaded to Pypi so the server can import it 
from the interwebs.
"""
